...
import static kim.marty.mtflibs.PROPERTY.*;
...
public class BaseUtils {
    ...
    public void setPwRegex(String pw_regex) {
        this.pw_regex = pw_regex;
    }
    ...
    public boolean isPwValid(String msg){
        return Pattern.matches(pw_regex,msg);
    }
    public boolean isPwValid(String regex , String msg){
        ...
        for(Map.Entry<String, TextView> elem : params.entrySet() ){
            ...
            switch (key){
                ...
                case VALIDATE_EMAIL:
                    ...
                    break;
                case VALIDATE_PW:
                    isvalidate &= isPwValid(tv.getText().toString());
                    break;
            }
